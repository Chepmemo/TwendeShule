...
public class ParentLocator extends Service implements LocationListener {
    ...
    public ParentLocator(Context context) {
    ...
    private void stopUsingGPS(){
    	...
    	if(locationManager != null){
            locationManager.removeUpdates(ParentLocator.this);
        }  
